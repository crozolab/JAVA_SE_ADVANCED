...
import amazonviewer.intefaces.MoviesDo;
import amazonviewer.model.*;
...
/**
 * <h1>Amazon Viewer</h1>
 * Amazon es un programa que permite visualizar Movies, Series con sus respectivos Chapters,
 * Books & Magazines. Te permite generar reportes generales y con fecha del dia
 * <p>
 * Existen algunas reglas para que los elementos sean visualizados
 * Existen algunas reglas para que los elementos sean visualizados
 * Existen algunas reglas para que los elementos sean visualizados
 * Existen algunas reglas para que los elementos sean visualizados
 * </p>
...
public class Main {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        Movie movie = new Movie("", "", "", 1, (short) 1992);
    ...
    public static void showMovies() throws SQLException {
    ...
    public static void showSeries() throws SQLException {
        int exit = 1;
    ...
    public static void showMagazines() throws SQLException {
    ...
    public static void makeReport() throws SQLException {
        ...
        movies.stream()
                ...
                .forEach(movie -> contentReport.append(movie.toString()).append("\n"));

        series.forEach(serie -> {
            ArrayList<Chapter> chapters = serie.getChapters();
            chapters.stream()
                    .filter(Film::getIsViewed)
                    .forEach((movie -> contentReport
                            .append(movie.toString())
                            .append("\n")));});
        books.stream()
                .filter(Book::getIsReaded)
                .forEach(book -> contentReport
    ...
    public static void makeReport(Date date) {
        ...
        List<Movie> moviesDate = movie.getMoviesByDate();
        for (Movie movieDate : moviesDate) {
            System.out.println("las peliculas son " + movieDate.toString());
                contentReport += movieDate.toString() + "\n";
        }
